...
function Header({ isMenuOpen, onToggleMenu, onNavigate, onOpenSearch }) {
  ...
  return <header className="site-header"><div className="container header-inner">
    ...
    <div className="header-actions">
      ...
      <LanguageSwitcher />
      <a href="tel:249570010" className="cta-button">
...
function App() {
  ...
  return <>
    ...
    <main>
      ...
      <section id="galeria" className="gallery-section"><div className="container"><h2>{t('gallery.title')}</h2><p className="section-intro">{t('gallery.intro')}</p><div className="gallery-grid">{gallery.map(([image, altKey], index) => <figure className="gallery-item" key={image} onClick={() => setLightboxIndex(index)}><img src={img(`gallery/${image}`)} alt={t(altKey)} /><div className="gallery-overlay"><p className="gallery-caption">{t(altKey)}</p></div></figure>)}</div></div></section>
