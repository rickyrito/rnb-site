...
function App() {
  ...
  return <>
    ...
    <main>
      ...
      <section id="portfolio" className="portfolio-section"><div className="container"><p className="eyebrow">{t('nav.portfolio')}</p><h2>{t('portfolio.title')}</h2><p className="section-intro">{t('portfolio.intro')}</p><div className="partners-grid">{partners.map(([image, alt]) => <div className="partner" key={image}><img src={img(`partners/${image}`)} alt={alt} /></div>)}</div></div></section>
